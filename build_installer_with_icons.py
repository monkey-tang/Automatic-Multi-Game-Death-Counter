"""
Build helper script that conditionally includes icon files in PyInstaller build.
...
def build_installer_online():
    """Build the online installer with conditional icon files."""
    ...
    cmd = [
        ...
        "--onefile", "--windowed",
        "--name", "DeathCounterInstaller-online",
    ]
...
if __name__ == "__main__":
    success = build_installer_online()
